...
description: Reference for production-quality UI work, covering components, layouts, state, forms, accessibility, responsive design, styling. Use when building or modifying user-facing interfaces, creating React/Vue/Svelte components, implementing a page or dashboard, adding a modal or form, fixing accessibility issues, or when the output needs to look and feel production-quality rather than AI-generated.
---
